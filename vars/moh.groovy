...
def fetchParams() {
    ...
    println "Fetched Sites: ${sites.join(', ')}"  // Debugging output
    println "Fetched Services: ${services.join(', ')}"  // Debugging output
    println "Fetched Version: ${version}"  // Debugging output
